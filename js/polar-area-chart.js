...
var config = {
    ...
    data: {
        datasets: [{
            data: [10, 20, 15, 5, 12, 23, 8, 30, 11, 10, 14, 18],
            backgroundColor: [
                ...
                window.chartColors.palegoldenrod,
...
window.onload = function() {
    ...
    window.polarAreaChart = new Chart(ctx, config);
};

function done() {
    var url = window.polarAreaChart.toBase64Image();
